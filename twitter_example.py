...
proxy = "xxxx:xxxxx@xx.xxx.xxx.xx:xxxx"  # Your proxy here
my_key = "Your_api_key_2captcha"

# Initialize SeleniumBase driver
driver = Driver(uc=True, headless=False, proxy=False)
...
try:
    ...
    while True:
        try:
            driver.find_element(By.NAME, "email").send_keys("rasputin@gmail.com")  # Your working email
            break
        except:
    ...
    driver.find_element(By.ID, "SELECTOR_1").send_keys("мая")  # Month
